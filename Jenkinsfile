pipeline {
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git branch: 'main', url: 'https://github.com/UserImaneEl/ProjetFront.git'
            }
        }
        ...
        stage('Run Container') {
            steps {
                script {
                    ...
                    bat 'docker run -d --name projetfront --restart always -p 8082:4200 imane02/projetfront:latest'
                }
            }
        }
    }
